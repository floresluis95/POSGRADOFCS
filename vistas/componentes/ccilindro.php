...
<div class="kt-container">
          ...
          <div class="col-lg-2">
						<div class="kt-portlet">
							...
							<button type="submit" class="btn btn-primary" >	<a href="extensiones/tcpdf/pdf/pdfcildisponbles.php" style="color:white;">IMPRIMIR</a><i class="fa fa-print" aria-hidden="true"></i></button>
                                    ...
                                    <form class="kt-form kt-form--label-right" method="POST">
                                        <div class="modal-body">
                                            <div class="kt-portlet__body">
                                                <h3 class="float-right"><i class="kt-menu__link-icon fa fa-angle-double-right"></i> BUSCAR CILINDRO</h3>
                                                <div class="form-group row form-group-marginless kt-margin-t-20">
                                                    <label class="col-lg-3 col-form-label">SERIE</label>
                                                <div class="col-lg-6">
                                                    <input type="text" class="form-control" name="seriecilindro" placeholder="Serie del cilindro" required >
                                                </div>    
        ...
        <table class="table">
             <thead>
              ...
              <tbody>
                  ...
                  <tfoot>
                           <?php
                          $ver = new BuscarcilControlador();
                          $ver -> BuscarcilControlador();
                          ?>
					        </tfoot>
              </tbody>
            </table>
