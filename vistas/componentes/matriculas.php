                ...
                <div class="kt-portlet__body">
                  ...
                  <table class="table table-striped- table-bordered table-hover table-checkable TablaUsuarios" id="kt_table_1">
                    ...
                    <tr>
										...
										<th scope="col">ULTIMO MOULOS INSCRITO</th>
										<th scope="col">DETALLE DE PAGOS</th>
                    <th scope="col">PAGAR MODULO</th>
										<th scope="col">EDITAR</th>
										<th scope="col">INFORMR DE PAGO</th>
										
                    </tr>
                  </thead>
                    <tbody>
					<?php
                       $ListaEstudiantesmatriculados = new EstudiantesControladores();
                       $ListaEstudiantesmatriculados->ListaEstudianteControladoresmatriculados();
                      ?>
                    </tbody>
					      </table>
		<!--end: Datatable -->
