              ...
              <div class="kt-container ">
                <div class="kt-subheader__main">
                  ...
                  <div class="kt-subheader__breadcrumbs">
					...
					<h3>NUEVA SOLICITUD DE CONVERSION</h3> </a> 
 ...
 <!--SOLICITUD"></i>-->
        ...
        <div class="kt-container  kt-grid__item kt-grid__item--fluid">
			...
			<!--Cliente-->
	            ...
	            <div class="kt-portlet__foot">
					<div class="kt-form__actions">
						<div class="row">
							...
							<div class="col-lg-7">
								<button type="submit"   style="background-color: #0385CD;" class="btn btn-brand">GENERAR SOLICITUD</button><br>
							</div>
				...
				<?php
					$registrovehi = new Solicitudcontroladores();
					$registrovehi -> RegistrarVehiculo();
				?>
			</form>
