          ...
          <div class="kt-aside-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_aside_menu_wrapper">
            <div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1">
              ...
              <ul class="kt-menu__nav ">
                ...
                <li class="kt-menu__item " aria-haspopup="true"><a href="nentrega" class="kt-menu__link "> <i class="kt-menu__link-icon fa fa-circle"></i> <span class="kt-menu__link-text">RECEPCION DE KITS GNV</span></a></li>
                ...
                <li class="kt-menu__item " aria-haspopup="true"><a href="matriculas" class="kt-menu__link "><i class="kt-menu__link-icon fa fa-file"></i><span class="kt-menu__link-text">MATRICULADOS</span></a></li>
