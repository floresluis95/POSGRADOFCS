...
error_reporting(0);  
$codigo = $this->codigo;
$Solicitud = ListaNotaModelos::ListaNotaModelocil();
...
$bloque4 = <<<EOF
	...
	<table style="font-size:10px; padding:5px 10px;">
		...
		<tr>
		<td style="border: 1px solid #666; background-color:white; width:150px; text-align:center">$item[fecharecepcioncil] </td>
