...
error_reporting(0);  
$codigo = $this->codigo;
$Solicitud = pdfkitModelos::pdfkitModelo($codigo);
...
DETALLE DE RECEPCION DE KIT'S GNV
</div>
<div style="font-size:10px; text-align:left; line-height:15px;">
	 FECHA DE RECEPCION:$fechc
</div>
	</table>
EOF;
...
$bloque3 = <<<EOF
	...
	<table style="font-size:10px; padding:5px 10px;">
		...
		<td style="border: 1px solid #666; color:#fff; background-color:navy; width:150px; text-align:center">SERIE</td>
		<td style="border: 1px solid #666;  color:#fff; background-color:navy; width:120px; text-align:center">MARCA</td>
        <td style="border: 1px solid #666;  color:#fff; background-color:navy; width:100px; text-align:center">TIPO</td>
...
$bloque4 = <<<EOF
	...
	<table style="font-size:10px; padding:5px 10px;">
		...
		<td style="border: 1px solid #666; background-color:white; width:150px; text-align:center">$item[seriekit] </td>
        <td style="border: 1px solid #666; background-color:white; width:120px; text-align:center">$item[descripcion]</td>
        <td style="border: 1px solid #666; background-color:white; width:100px; text-align:center">$item[tipo]</td>
