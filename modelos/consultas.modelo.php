<?php
    ...
    {
        public static function pdfTrabajosConcluidos($inicio,$final)
        {
        ...
        public static function tipotransporte($inicio,$final)
        {
        ...
        public static function motor($inicio,$final)
        {
        ...
        public static function TrabajosConcluidosModelo($inicio,$final)
        {
        ...
        public static function Trabajossolicitados($inicio,$final)
        {
        ...
        public static function trabajosprogramados($inicio,$final)
        {
            $stmt = Conexion::Conectar()->prepare("SELECT s.codsolicitud, s.fechasolicitud, s.estado, p.nombre,p.paterno,v.nroplaca, s.fechaconcluido, ds.fechatrabajo FROM solicitud s INNER JOIN propvehiculo pv on s.idpropvehiculo =pv.idpropvehiculo
            INNER JOIN propietario p on pv.Idpropietario=p.idpropietaro
            INNER JOIN vehiculo v on pv.idpropvehiculo=v.idvehiculo
    ...
    {
        public static function pdfKitdisponibles()
        {
        ...
        public static function pdfKitdisponiblesinyeccioncarburador()
        {
        ...
        public static function totalkit()
        {
        ...
        public static function ListaKitdisponibles($seriekit)
        {
        ...
        public static function ListaKitAsignado($seriekit)
        {
        ...
        public static function ConsultakitModelo($seriekit)
        {
    ...
    {
        public static function pdfcildisponiblesdesc()
        {
        ...
        public static function pdfcildisponibles()
        {
        ...
        public static function pdfcildisponiblespormarca()
        {
        ...
        public static function concluidoModelo($seriecilindro)
        {
            $stmt = Conexion::Conectar()->prepare("SELECT * FROM (solicitud s INNER JOIN dsolicitud ds ON s.codsolicitud=ds.codsolicitud)
            inner JOIN detalle de on de.dsolicitudt=s.codsolicitud
            INNER JOIN propvehiculo pr on pr.idpropvehiculo =s.idpropvehiculo
        ...
        public static function ListaCilAsignado($seriecilindro)
        {
        ...
        public static function Listacildisponibles($seriecilindro)
        {
        ...
        public static function pdfCildisponiblesmarca()
        {
